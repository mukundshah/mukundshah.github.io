...
const formatTechs = (values: string[]): string => values.toString().replaceAll(',', ' • ')
</script>

<template>
  <div
    v-if="isComingSoon"
    class="group flex w-full flex-col justify-between gap-2 rounded-md border border-neutral-700 p-4 md:flex-row md:items-center"
  >
    ...
    <p class="w-fit rounded-md bg-neutral-900 px-4 py-1">
      Soon
    </p>
  </div>
